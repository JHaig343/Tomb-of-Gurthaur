#Run me to create a .exe file of the game for Windows systems
...
def get_data_files(base_dir, target_dir, list = []):
    ...
    " *
    " *     returns: A list of relative and full path pairs. This is specified by disutils.
    """
...
#Build a dict of the options we want.
opts = {'py2exe': {
    'ascii': 'True',
